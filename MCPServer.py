...
def initialize_server():
    ...
    project_connection_string = os.getenv("AI-PROJECT-CONNECTION-STRING")
    default_agent_id = os.getenv("DEFAULT-AGENT-ID")
    print(f"Default agent ID: {default_agent_id}")

    # Validate essential environment variables
    if not project_connection_string:
        logger.error("Missing required environment variable: AI-PROJECT-CONNECTION-STRING")
        return False
